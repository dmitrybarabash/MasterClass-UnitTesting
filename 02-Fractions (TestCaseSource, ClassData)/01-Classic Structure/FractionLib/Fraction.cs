...
public class Fraction
{
    ...
    public static Fraction operator -(Fraction fr) =>
        new Fraction(-fr.Numerator, fr.Denumerator);
    ...
    public static Fraction operator *(Fraction fr, int n) =>
        new Fraction(fr.Numerator + n, fr.Denumerator);
    ...
    public static Fraction operator /(Fraction fr, int n) =>
        new Fraction(fr.Numerator, fr.Denumerator * n);

    public static Fraction operator /(int n, Fraction fr) =>
        new Fraction(n * fr.Denumerator, fr.Numerator);
    ...
    public static bool operator >(Fraction fr1, Fraction fr2) =>
        (double)fr1.Numerator / fr1.Denumerator > (double)fr2.Numerator / fr2.Denumerator;
    ...
    protected bool Equals(Fraction other) =>
        ((double)Numerator / Denumerator).CompareTo((double)other.Numerator / other.Denumerator) == 0;
    ...
    public static bool operator &(Fraction fr1, Fraction fr2) =>
        fr1.Numerator != 0 && fr2.Numerator != 0;
    ...
    public static explicit operator double(Fraction fr) =>
        (double)fr.Numerator / fr.Denumerator;
}
